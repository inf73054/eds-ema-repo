...
// The homepage is structurally identical to the about-us template (same 7 blocks,
// same section order and styles). Reuses the about-us infrastructure verbatim.
const PAGE_TEMPLATE = {
  name: 'home',
...
export default {
  transform: (payload) => {
    ...
    // Homepage: root path "/" sanitizes to empty, so publish as /index.
